import {AfterViewInit,SimpleChanges,OnChanges, Component, ElementRef, Input, Renderer2, ViewChild} from '@angular/core';
...
export class TimeAreaClockComponent implements AfterViewInit{
