...
@Component({
  ...
  templateUrl: './task-detail-bottomSheet.component.html',
  styleUrls: ['./task-detail-bottomSheet.component.scss']
})
export class TaskDetailBottomSheetComponent implements OnInit, OnDestroy {
  user: UserInterface;
  ...
  constructor(private api: ApiService,
              ...
              public bottomsheetRef: MatBottomSheetRef<TaskDetailBottomSheetComponent>,
